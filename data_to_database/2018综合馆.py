...
filepath = 'E:/data/2018综合馆汇总.docx'
...
table_name = ['包头科技馆', '大庆科技馆', '东莞科技馆', '佛山科技馆', '广东科学中心', '黑龙江科技馆', '内蒙古科技馆', '宁波探索中心', '中国科技馆']
...
for index, table in enumerate(tables):
    ...
    for i in range(4,len(table.rows)):#从表格第5行开始循环读取表格数据 len(table.rows)
        ...
        data = {"label": "2018综合馆", "venue": venueName, "item": item, "imgList": [], "videoList": []}
        db.data.insert(data)
    #     datas.append(data)
